...
const char* mqtt_username = "vadrev";
...
void callback(char* topic, byte* payload, unsigned int length) {
  ...
  // Start experiment upon receiving the command
  if (strcmp(topic, "controlTopic") == 0 && strncmp((char*)payload, "start", length) == 0) {
...
void setup() {
  Serial.begin(115200);
  setup_wifi();
  espClient.setCACert(root_ca); // Set the CA certificate
