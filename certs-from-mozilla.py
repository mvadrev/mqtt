...
if which('./xtensa-lx106-elf-ar.exe') is None and not os.path.isfile('./xtensa-lx106-elf-ar.exe') and not os.path.isfile('./xtensa-lx106-elf-ar.exe'):
...
arCmd = ['./xtensa-lx106-elf-ar.exe', 'q', 'data/certs.ar'] + derFiles;
call( arCmd )
